...
nx run-many --target=serve --projects=shell
...
docker-compose --profile prod build shell-prod

# Redémarrer products
docker-compose --profile prod up -d shell-prod
```
